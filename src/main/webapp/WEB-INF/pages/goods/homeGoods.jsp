                ...
                <c:if test="${empty cur_user}">
                    <li class="publish-btn">
                       <button onclick="showLogin()" data-toggle="tooltip" 
                                title="您需要先登录哦！" class="blue lighten-1 waves-effect waves-light btn" 	>
                            我要发布</button>
                    </li>
                </c:if>
                <c:if test="${!empty cur_user}">
...
<div ng-controller="sidebarController" class="sidebar stark-components ng-scope">
    ...
    <div class="info">
        ...
        <a href="#">联系我们</a>
        <p>©2021 菜园交易市场</p>
        <span><a href="<%=basePath%>admin" style="color:navy;font-size:25px;text-decoration:underline">后台管理</a></span>
    </div>
</div>
<!--
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到 菜园 交易市场。临近毕业季的</p>
                                <p class="text3">你，是否有太多的闲置与校友分享，为了追求更好的校园服</p>
                                <p class="text4">务，我们打造了一个全新的校园平台——<span>菜园交易市场</p>
                                <p class="text5">这里有更多的闲置分享，更自由的校园话题讨论，你想要的，都在这里。</p>
                                <p class="text6">加入菜园交易市场，你的大学，会更精彩。</p>
                            </ul>
                          <!--   <div class="logoimg">
